...
function PetWorkSpaceItemData:GetDuringTime()
  ...
  if curTime < self.lastRewardTime then
    helplog("\229\188\130\229\184\184,\230\156\141\229\138\161\229\153\168\230\151\182\233\151\180\232\162\171\230\148\185\228\186\134 \228\184\138\228\184\128\230\172\161\233\162\134\229\165\150\230\151\182\233\151\180 ", self.lastRewardTime, "\229\189\147\229\137\141\230\156\141\229\138\161\229\153\168\230\151\182\233\151\180: ", curTime)
    return 0
  end
...
function PetWorkSpaceItemData:GetMaxRewardMulti()
  ...
  if starttime < startRefreshTime then
    multiple = multiple + 1 or multiple
  end
  if curServerTime > curRefreshTime then
    multiple = multiple + 1 or multiple
  end
...
function PetWorkSpaceItemData:GetUIReward()
  ...
  if (self.curCounts == nil or #self.curCounts == 0) and multiple > 0 and 0 < #self.rewardArray then
    local item = {}
