...
function UILayer:AddChild(node, pushStack)
  ...
  if node and not GameObjectUtil.Instance:ObjectIsNULL(node.gameObject) then
    ...
    printRed(string.format("%s Layer\230\131\179\230\183\187\229\138\160\228\184\128\228\184\170\228\184\141\229\173\152\229\156\168\231\154\132uinode", self.name))
  end
  return false
end
