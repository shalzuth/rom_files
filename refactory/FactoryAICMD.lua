...
function FactoryAICMD.GetGetOnSeatCmd(seatID, fromCreature)
  local cmd = FactoryAICMD.GetOnSeatCmd
  cmd[2] = seatID
  cmd[3] = fromCreature
  return cmd
end
function FactoryAICMD.GetGetOffSeatCmd(seatID, fromCreature)
...
function FactoryAICMD.Me_GetSkillCmd(skillID, targetCreature, targetPosition, ignoreNavMesh, forceTargetCreature, allowResearch, noLimit, ignoreCast)
