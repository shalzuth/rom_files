...
function GOLuaPoolManager:ctor()
  ...
  self.astrolabePool = GOLuaPool.new("Astrolabe", self.gameObject, 0, 800)
  ...
  self.role_part_bodyPool = GOLuaPool.new("role_part_bodyPool", self.gameObject, 80, 200, true)
  self.role_part_hairPool = GOLuaPool.new("role_part_hairPool", self.gameObject, 80, 200, true)
