...
function EnviromentManager.ApplySceneObject(info, applyArgs, prevInfo)
  ...
  if nil ~= info and info.enable and nil ~= sceneObjectMaterials and #sceneObjectMaterials > 0 then
  ...
  elseif nil ~= sceneObjectMaterials and #sceneObjectMaterials > 0 then
    for i = 1, #sceneObjectMaterials do
      local mat = sceneObjectMaterials[i]
