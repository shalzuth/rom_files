...
function AssetManager_Enviroment:ApplySkyboxCubemap(applyArgs)
  ...
  if oldAlphaPath ~= applyArgs.assetPathSkyboxCubemapAlpha and nil ~= self.assetSkyboxCubemapAlpha then
  ...
  elseif nil ~= self.assetPathSkyboxCubemap and "" ~= self.assetPathSkyboxCubemap then
    self.assetManager:LoadAsset(self.assetPathSkyboxCubemap, Cubemap, self.OnAssetLoaded_SkyboxCubemap, self, self.assetPathSkyboxCubemap)
  end
  if nil == self.assetSkyboxCubemapAlpha and nil ~= self.assetPathSkyboxCubemapAlpha and "" ~= self.assetPathSkyboxCubemapAlpha then
    self.assetManager:LoadAsset(self.assetPathSkyboxCubemapAlpha, Cubemap, self.OnAssetLoaded_SkyboxCubemapAlpha, self, self.assetPathSkyboxCubemapAlpha)
  end
end
function AssetManager_Enviroment:ApplySunFlare(applyArgs)
  ...
  self.assetManager:LoadAsset(self.assetPathSunFlare, Flare, self.OnAssetLoaded_SunFlare, self, self.assetPathSunFlare)
end
