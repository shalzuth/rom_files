...
function AI_CMD_Myself_MoveToHelper:Start(time, deltaTime, creature, p, ignoreNavMesh)
...
function AI_CMD_Myself_MoveTo:Start(time, deltaTime, creature)
  ...
  local ret = Helper.Start(self, time, deltaTime, creature, self.args[1], self.args[2], self.args[6])
  if ret then
