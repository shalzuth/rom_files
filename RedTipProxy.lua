...
--id???????????????ID?????????SceneTip.proto???ERedSys??????
--ui??????????????????uiwidget,uiwidget,uiwidget???gameobject(????????????????????????)
--depth???offset,side?????????????????????depth?????????depth??? offset????????????????????????{0,0},side???NGUIUtil.AnchorSide??????
