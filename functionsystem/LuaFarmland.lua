...
function LuaFarmland:GetPosBaseUnit(unit_index)
  if unit_index > 0 and unit_index <= self.csfarmland.unitIndexMax and 0 < self.csfarmland.widthBaseUnit then
    local line = 0
    local column = 0
...
function LuaFarmland:TryPlayAudio()
  ...
  if not audioSource.isPlaying and self.csfarmland.plantType == LuaFarmland.PlantType.Wheat then
