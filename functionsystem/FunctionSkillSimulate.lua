  ...
  if fitCost then
    ...
    if fitJobLv then
      ...
      MsgManager.ShowMsgByIDTable(603, {
        Table_Class[simulate.profession].NameZh,
    ...
    do
      ...
      if nextProfess then
        ...
        while foundNotFitPointsProfess == nil and nextProfess ~= nil and count <= 5 do
          ...
          if nextProfess.active and 0 < nextProfess.points and uptoSkillPoints <= (nextProfess.index - 1) * unlockPoints + extraPoints then
...
function FunctionSkillSimulate:ScallAllDatas()
  ...
  local cell, p, fitJob, fitRequiredSkill, hasPoint, pActive
    ...
    if p.skills then
      ...
      for k, skill in pairs(p.skills) do
        ...
        if cell then
          ...
          elseif fitJob and fitRequiredSkill and hasPoint and pActive then
