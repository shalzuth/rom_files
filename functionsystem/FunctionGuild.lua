  ...
  for i = 1, #npcfunction do
    ...
    if funcCfg then
      if funcCfg.NameEn == "CreateGuild" or funcCfg.NameEn == "ApplyGuild" then
        ...
        break
      elseif funcCfg.NameEn == "UpgradeGuild" or funcCfg.NameEn == "DisMissGuild" or funcCfg.NameEn == "CancelDissolution" or funcCfg.NameEn == "ChangeGuildName" or funcCfg.NameEn == "ChangeGuildLine" or funcCfg.NameEn == "GiveUpGuildLand" then
...
function FunctionGuild:SetGuildLandIcon(flagID, portrait, guildId)
  ...
  if guildHeadData.type == GuildHeadData_Type.Config then
    if not guildHeadData or not guildHeadData.staticData.Icon then
      local guildIcon
    end
