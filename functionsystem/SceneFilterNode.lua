    ...
    if conf then
      ...
      for i = 1, #conf.Targets do
        ...
        if SceneFilterNode.NodePool.Targets[target] then
          ...
          errorLog("\229\177\143\232\148\189ID %s \228\184\173\233\133\141\231\189\174\231\154\132target %s\231\168\139\229\186\143\230\156\170\230\148\175\230\140\129", id, target)
        end
      end
...
function SceneFilterNode:_AddRanges(_Ranges)
  ...
  for i = 1, #_Ranges do
    ...
    if SceneFilterNode.NodePool.Ranges[range] then
      ...
      errorLog("\229\177\143\232\148\189ID %s \228\184\173\233\133\141\231\189\174\231\154\132range %s\231\168\139\229\186\143\230\156\170\230\148\175\230\140\129", id, range)
    end
  end
end
