...
GvgFinalFightTip.EGvgTowerType = {
	[FuBenCmd_pb.EGVGTOWERTYPE_CORE] = {name = "???????????????",totalValue = GameConfig.GvgDroiyan.RobPlatform_RobValue or 1800},
	[FuBenCmd_pb.EGVGTOWERTYPE_WEST] = {name = "?????????????????????",totalValue = GameConfig.GvgDroiyan.RobPlatform_RobValue or 1800},
	[FuBenCmd_pb.EGVGTOWERTYPE_EAST] = {name = "?????????????????????",totalValue = GameConfig.GvgDroiyan.RobPlatform_RobValue or 1800},
}
