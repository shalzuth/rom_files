...
FunctionLogin.ErrorCode = {
	RequestAuthAccToken_NoneToken = 2001,  -- ????????????token??????token??????
	StartActive_NoneToken = 2002,   -- ??????????????????token??????
	CheckAccTokenValid_Failure_GetServerListFailure = 2005, -- ?????? ???????????? ?????????????????????????????????
	CheckAccTokenValid_Failure_CreateRoleFailure = 2006,-- ?????? ???????????? ??????????????????????????????
	Login_TokenInValid =  2010, -- token ??????
	LoginDataHandler_ServerListEmpty =  2011, -- ?????????????????????
	Login_SDKLoginFailure = 2008,  --sdk????????????
	Login_SDKLaunchFailure =  2009,  -- sdk ????????????
	Login_SDKLoginCancel = 2012,  --sdk????????????
	StartGameLogin_NoneSdkType = 2013,  --sdk Type ??????
	AuthHostHandler_Failure = 10000,  -- ?????? ??????token?????? ??????
	...
	LoginAnnounceFormatError = 900001 -- ???????????????????????????JSON???
}
...
function FunctionLogin:ctor()
	...
	-----Important!!!!!!!!! ??????????????????false
	self.privateMode = false -- todo xde ??????false
	self.PrivatePlat = 90
	-----Important!!!!!!!!! ??????????????????false

	--?????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
	self.ShowWeChat = not Game.inAppStoreReview
	self.Debug = false  -- todo xde ?????? false
	--self.debugServerVersion = "1.0.15" todo xde
	self.debugServerVersion = "1.0.0"
	self.debugPlat = 1  -- (????????????: 2 ,????????????: 3, ?????????: 1)
	self.debugServerPort = 8888 -- ????????????5025/5023 ???????????????5001  ???????????????xxx tw 8888 --todo xde
	self.debugAuthPort = 5003 -- ????????????5003 ???????????????5002  ???????????????xxxx
