...
-- end
-- LogUtility.InfoFormat("??????1 cpu:{0}  memory:{1}",(os.clock()-cpu),(collectgarbage("count")-mem))
...
-- end
-- LogUtility.InfoFormat("??????2 cpu:{0}  memory:{1}",(os.clock()-cpu),(collectgarbage("count")-mem))
