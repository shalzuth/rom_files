...
function PetInfoView:Init()
  self:InitView()
  self:MapEvent()
  self.friendly_valuelab.fontSize = 15
  self.level_valuelab.fontSize = 15
  local FriendlySymbol = self:FindGO("FriendlySymbol"):GetComponent(UISprite)
  OverseaHostHelper:FixAnchor(FriendlySymbol.leftAnchor, self.friendly_valuelab.transform, 0, -21)
  OverseaHostHelper:FixAnchor(FriendlySymbol.rightAnchor, self.friendly_valuelab.transform, 0, 10)
end
