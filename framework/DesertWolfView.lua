...
function DesertWolfView:FindObjs()
  ...
  local Label1 = self:FindGO("Label1", self.empty):GetComponent(UILabel)
  OverseaHostHelper:FixLabelOverV1(Label1, 3, 320)
  local Label2 = self:FindGO("Label2", self.empty):GetComponent(UILabel)
  OverseaHostHelper:FixLabelOverV1(Label2, 3, 700)
end
