...
function SceneCarrierProxy:TryCreateCarrier(carrierID, masterID)
  ...
  if not carrier then
    ...
    if not alreadyInCarrier then
      ...
      errorLog(string.format("\229\156\186\230\153\175\228\184\173\229\183\178\231\187\143\230\156\137masterid\228\184\186%s\231\154\132\232\189\189\229\133\183\228\186\134\239\188\140\230\156\141\229\138\161\229\153\168\228\185\157\229\177\143\229\143\136\233\128\154\231\159\165\230\183\187\229\138\160\228\186\134\228\184\128\230\172\161", masterID))
    end
  end
  return carrier
end
