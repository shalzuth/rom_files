...
function AnnounceQuestPanelCell:initView()
  ...
  OverseaHostHelper:FixLabelOverV1(self.questName, 3, 180)
  ...
  ratioTip.text = ZhString.AnnounceQuestPanel_MultiRewardTip
...
function AnnounceQuestPanelCell:playRatioUpAnm()
  if self.data and (self.data:getQuestListType() == SceneQuest_pb.EQUESTLIST_ACCEPT or self.data:getQuestListType() == SceneQuest_pb.EQUESTLIST_CANACCEPT) then
