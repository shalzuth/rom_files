...
function ServicePlayerActionCommand:DoServerPlayerBeheavior(playerid, type, value)
  ...
  if type == SceneUser2_pb.EUSERACTIONTYPE_ADDHP then
    ...
    if player == Game.Myself then
      ...
      SkillLogic_Base.ShowDamage_Single(CommonFun.DamageType.Normal, value, pos, HurtNumType.HealNum, HurtNumColorType.Treatment, player)
      pos:Destroy()
    end
  ...
  elseif type == SceneUser2_pb.EUSERACTIONTYPE_DIALOG and playerid == Game.Myself.data.id then
