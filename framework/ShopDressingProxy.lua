    ...
    if heroLevel >= tonumber(limitedLevel) then
      if v.goodsID and v.goodsID ~= 0 then
        if self.shopType == dressShopType.Hair then
          ...
          if hairStyleData and hairStyleData.Sex and (MyselfProxy.Instance:GetMySex() == hairStyleData.Sex or hairStyleData.Sex == 3) and hairStyleData.IsPro and hairStyleData.IsPro == 1 and hairStyleData.OnSale and hairStyleData.OnSale == 1 then
        ...
        elseif self.shopType == dressShopType.EyeLenses then
          ...
          if eyeStaticData and eyeStaticData.Sex and (MyselfProxy.Instance:GetMySex() == eyeStaticData.Sex or eyeStaticData.Sex == 3) and eyeStaticData.IsPro and eyeStaticData.IsPro == 1 and eyeStaticData.OnSale and eyeStaticData.OnSale == 1 then
...
function ShopDressingProxy:_sortHairFunc(left, right)
  ...
  if not left.ShopOrder or not right.ShopOrder then
    helplog("Shop\232\161\168\228\184\173\229\143\145\229\158\139\231\137\169\229\147\129\230\156\170\233\133\141ShopOrder\229\173\151\230\174\181")
    return false
  end
...
function ShopDressingProxy:_colorSortFunc(left, right)
  ...
  if not left.ShopOrder or not right.ShopOrder then
    helplog("Shop\232\161\168\229\143\145\229\158\139\233\162\156\232\137\178\231\137\169\229\147\129\228\184\173\230\156\170\233\133\141ShopOrder\229\173\151\230\174\181.")
    return false
  end
...
function ShopDressingProxy:bSameItem(type)
  ...
  elseif ShopDressingProxy.DressingType.ClothColor == type and tableData and tableData.clothColorID then
