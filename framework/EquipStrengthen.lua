...
function EquipStrengthen:CollectGO()
  ...
  self.labelNowLevelTitle = self:FindGO("LevelTitle", self.goNowLevel):GetComponent(UILabel)
  ...
  self.labelNowLevelTitle.pivot = UIWidget.Pivot.Left
  self.labelNowLevelTitle.transform.localPosition = Vector3(-110, 19, 0)
  OverseaHostHelper:FixLabelOverV1(self.labNowAttributeTitle, 3, 130)
  self.labNowAttributeTitle.pivot = UIWidget.Pivot.Left
  self.labNowAttributeTitle.transform.localPosition = Vector3(-110, -20, 0)
  self.labNowAttributeValue.transform.localPosition = Vector3(25, -20, 0)
  self.labnextLevelTitle.pivot = UIWidget.Pivot.Left
  self.labnextLevelTitle.transform.localPosition = Vector3(-110, 19, 0)
  OverseaHostHelper:FixLabelOverV1(self.labNextAttributeTitle, 3, 130)
  self.labNextAttributeTitle.pivot = UIWidget.Pivot.Left
  self.labNextAttributeTitle.transform.localPosition = Vector3(-110, -20, 0)
  self.labNextAttributeValue.transform.localPosition = Vector3(25, -20, 0)
end
...
function EquipStrengthen:StrengthHandler(note)
  ...
  if strengthenCount > 0 then
    ...
    if 0 < note.cricount then
      self:PlayUIEffect(EffectMap.UI.upgrade_surprised, self.itemPreviewCell.gameObject, true, EquipStrengthen.Upgrade_surprisedEffectHandle, self)
    else
      self:PlayUIEffect(EffectMap.UI.upgrade_success, self.itemPreviewCell.gameObject, true, EquipStrengthen.Upgrade_successEffectHandle, self)
    end
