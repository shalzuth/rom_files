...
function ServiceItemProxy:CallLotteryCmd(year, month, npcid, skip_anim, price, ticket, type, count, items, charid, guid, today_cnt)
  local now = Time.unscaledTime
  if self._callLottery ~= nil and self._receiveLottery == nil then
    Debug.LogError("\232\183\157\231\166\187\228\184\138\230\172\161\230\137\173\232\155\139 3 \231\167\146\228\187\165\229\134\133\229\185\182\228\184\148\230\178\161\230\156\137\230\148\182\229\136\176\230\156\141\229\138\161\229\153\168\229\155\158\229\164\141\239\188\140\229\136\164\230\150\173\228\184\186\230\150\173\231\186\191\239\188\140\228\184\141\229\164\132\231\144\134\230\137\173\232\155\139\232\175\183\230\177\130")
    return
  end
  if self._callLottery == nil or now - self._callLottery >= 1 then
    ...
    Debug.LogError("\232\183\157\231\166\187\228\184\138\230\172\161\230\137\173\232\155\139 1 \231\167\146\228\187\165\229\134\133\239\188\140\228\184\141\229\164\132\231\144\134\230\137\173\232\155\139\232\175\183\230\177\130")
  end
end
...
function ServiceItemProxy:RecvLotteryCmd(data)
  helplog("RecvLotteryCmd", os.date())
  self._receiveLottery = Time.unscaledTime
...
function ServiceItemAutoProxy:RecvQueryDebtItemCmd(data)
  MyselfProxy.Instance:SetDebts(data.items)
...
function ServiceItemProxy:RecvLotteryActivityNtfCmd(data)
  LotteryProxy.Instance:RecvLotteryActivityInfo(data.infos)
  self:Notify(ServiceEvent.ItemLotteryActivityNtfCmd, data)
end
function ServiceItemProxy:RecvQueryFavoriteListItemCmd(data)
  BagProxy.Instance:RecvQueryFavoriteListItem(data.items)
  self:Notify(ServiceEvent.ItemQueryFavoriteListItemCmd, data)
end
function ServiceItemProxy:RecvFavoriteItemActionItemCmd(data)
  BagProxy.Instance:RecvFavoriteItemAction(data.action, data.itemids)
