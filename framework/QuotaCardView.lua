...
function QuotaCardView:FindObjs()
  ...
  self.pointLimitDate.transform.localPosition = Vector3(-170, -260, 0)
  local dateL = self:FindGO("lab", self.pointLimitDate):GetComponent(UILabel)
  dateL.fontSize = 16
  dateL.transform.localPosition = Vector3(20, 0, 0)
end
...
function QuotaCardView:InitUIView()
  ...
  self.desc.text = ZhString.QuotaCard_Desc_JP
