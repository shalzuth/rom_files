...
function UIListItemViewControllerItem:Init()
  ...
  self.labName.pivot = UIWidget.Pivot.Top
  self.labName.transform.localPosition = Vector3(0, -94, 0)
  self.labName.fontSize = 16
  OverseaHostHelper:FixLabelOverV1(self.labName, 3, 100)
end
