...
function QuestDetailTip:SetData(data)
  ...
  if self.rewardDetail then
    for _, v in pairs(self.rewardDetail.labelMap) do
      helplog(v.richLabel.gameObject)
      OverseaHostHelper:FixLabelOverV1(v.richLabel, 3, 240)
    end
  end
