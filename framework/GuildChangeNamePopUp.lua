...
function GuildChangeNamePopUp:Init()
  self.super.Init(self)
  local Tip = self:FindGO("Title"):GetComponent(UILabel)
  OverseaHostHelper:FixLabelOverV1(Tip, 3, 300)
  local TimeTip = self:FindGO("TimeTip")
  local Label = self:FindGO("Label", TimeTip):GetComponent(UILabel)
