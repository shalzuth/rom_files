...
function GvgFinalSectionCell:SetData(data)
  ...
  if twCf then
    ...
    if guildInfo then
      self.ownerName.text = "\229\189\146\229\177\158\230\150\185: " .. guildInfo.guildname
      self.ownerName.text = ZhString.Oversea_Hard_Code_Client_7 .. guildInfo.guildname
    else
