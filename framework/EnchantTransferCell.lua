      ...
      for i = 1, #combineEffects do
        ...
        if buffData then
          if combineEffect.isWork then
            enchantAttrText = enchantAttrText .. STR_FORMAT(COMBINE_FORMAT, buffData.BuffName, buffData.BuffDesc)
          else
            enchantAttrText = enchantAttrText .. STR_FORMAT(WORKTIP_FORMAT, buffData.BuffName, buffData.BuffDesc, combineEffect.WorkTip)
          end
        end
      end
    end
