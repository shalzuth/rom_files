...
function SwitchRolePanel:UpdateServerList(note)
  ...
  if SDKEnable then
    ...
    if serverDatas and #serverDatas > 1 then
      ...
      if PlayerPrefs.HasKey(SwitchRolePanel.serverid) and PlayerPrefs.GetInt(SwitchRolePanel.serverid) ~= 0 then
        local serverId = PlayerPrefs.GetInt(SwitchRolePanel.serverid)
