...
function StudentView:FindObj()
  ...
  local Label = self:FindGO("Label", self.addStudent):GetComponent(UILabel)
  Label.pivot = UIWidget.Pivot.Left
  Label.transform.localPosition = Vector3(50, 20, 0)
  local Label1 = self:FindGO("Label1", self.addStudent):GetComponent(UILabel)
  OverseaHostHelper:FixLabelOverV1(Label1, 3, 360)
  Label1.pivot = UIWidget.Pivot.Left
  Label1.transform.localPosition = Vector3(50, -20, 0)
end
