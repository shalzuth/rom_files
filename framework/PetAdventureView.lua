...
function PetAdventureView:StartPetAdventure()
  ...
  if chooseData.staticData.Cost and chooseData.staticData.Cost.id then
    ...
    if petNum ~= #staticNum then
      helplog("Table_Pet_Adventure cost \233\133\141\231\189\174\233\148\153\232\175\175,\233\148\153\232\175\175ID: ", chooseData.staticData.id)
      return
    end
...
function PetAdventureView:_updateInfoByState()
  ...
  elseif staticdata.Cost and staticdata.Cost.id then
    ...
    if staticPetNum ~= #staticNum then
      helplog("Table_Pet_Adventure cost \233\133\141\231\189\174\233\148\153\232\175\175,\233\148\153\232\175\175ID: ", staticdata.id)
      return
    end
  ...
  for i = 1, #condition do
    ...
    if nil == conditionData then
      helplog("Table_Pet_AdventureCond \233\133\141\231\189\174\233\148\153\232\175\175\239\188\140\233\148\153\232\175\175ID\239\188\154", tostring(condition[i]))
      return
    end
  ...
  if chooseData.rareReward then
    for i = 1, #chooseData.rareReward do
      ...
      if status == PetAdventureProxy.QuestPhase.MATCH then
        ...
        if n < 1 then
          helplog("\231\168\128\230\156\137\229\165\150\229\138\177\230\149\176\233\135\143\229\143\145\233\128\129\233\148\153\232\175\175")
        end
        if rareCount == 0 then
...
function PetAdventureView:ShowPetModel(index)
  ...
  if 0 == matchPetID or not Asset_RoleUtility.CreateMonsterRoleParts(matchPetID) then
    local parts
  end
