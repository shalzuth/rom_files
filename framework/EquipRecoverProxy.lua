...
function EquipRecoverProxy.IsEquipNeedRecover(itemData)
  ...
  elseif itemData.enchantInfo and 0 < #itemData.enchantInfo:GetEnchantAttrs() then
    return true
  elseif equipInfo and 0 < equipInfo.equiplv then
    return true
  end
  return false
end
...
function EquipRecoverProxy:GetRecoverToggle(item)
  ...
  if item and item.equipInfo and (item.equipInfo.strengthlv > 0 or 0 < item.equipInfo.strengthlv2) then
  ...
  if item and item.enchantInfo and 0 < #item.enchantInfo:GetEnchantAttrs() then
