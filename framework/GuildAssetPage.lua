...
function GuildAssetPage:GreyToggle(b)
  if self.container.assetTog then
    ...
    if label then
      if b then
        tempColor:Set(0.00392156862745098, 0.00784313725490196, 0.011764705882352941)
        sprite.color = tempColor
        tempColor:Set(0.615686274509804, 0.615686274509804, 0.615686274509804)
        label.effectColor = tempColor
      else
        tempColor:Set(1, 1, 1, 1)
        sprite.color = tempColor
        tempColor:Set(0.11372549019607843, 0.17647058823529413, 0.4627450980392157)
        label.effectColor = tempColor
      end
    end
  end
