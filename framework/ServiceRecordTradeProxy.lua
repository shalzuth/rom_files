...
function ServiceRecordTradeProxy:RecvItemSellInfoRecordTradeCmd(data) 
	-- ShopMallProxy.Instance:RecvExchangeItemSellInfo(data)
...
function ServiceRecordTradeProxy:CallReqServerPriceRecordTradeCmd(charid, itemData, price, issell, statetype, count, buyer_count, end_time)
	local serverItem = itemData and itemData:ExportServerItem() or nil;
	ServiceRecordTradeProxy.super.CallReqServerPriceRecordTradeCmd(self, charid, serverItem, price, issell, statetype, count, buyer_count, end_time)
end
...
function ServiceRecordTradeProxy:RecvHotItemidRecordTrade(data)
	-- printOrange("RecvHotItemidRecordTrade")
...
function ServiceRecordTradeProxy:RecvReqGiveItemInfoCmd(data)
	...
	self:sendNotification(UIEvent.JumpPanel, {view = PanelConfig.ExchangeSignExpressView})
