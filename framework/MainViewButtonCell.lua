	...
	if(data.type == MainViewButtonType.Menu)then
		...
		if result == false then
			...
			if spriteData ~= nil then
				...
				redlog("设置 icon 错误，使用多语言图集后仍然没有找到 sprite", sName, self.sprite.atlas)
			end
		else
			-- helplog('设置 icon 成功', sName)
		end
		--]]
