...
function ServiceSessionTeamAutoProxy:CallTeamList(type, page, lv, querytype, list)
...
function ServiceSessionTeamAutoProxy:CallCreateTeam(minlv, maxlv, type, autoaccept, name, state, desc)
...
function ServiceSessionTeamAutoProxy:CallQueryMemberTeamCmd(teamid, members)
