...
autoImport("MainViewExpRaidPage")
...
function MainViewTraceInfoPage:initView()
  ...
  self.expRaidBord = self:AddSubView("ExpRaidInfoBord", MainViewExpRaidPage)
  self:InitAltManRaid()
end
function MainViewTraceInfoPage:AddViewEvts()
  ...
  self:AddListenEvt(PVEEvent.ExpRaid_Launch, self.HandleEnterExpRaid)
  self:AddListenEvt(PVEEvent.ExpRaid_Shutdown, self.HandleExitExpRaid)
  self:MapCardEvent()
...
function MainViewTraceInfoPage:HandlePolyDungeonLaunch(note)
  ...
  self.curBord = self.polyInfoBord
end
...
function MainViewTraceInfoPage:GetTeamPwsBord()
  ...
  local container = self:FindGO("TraceInfoBord")
  self.teamPwsBord = cls.new(container)
  return self.teamPwsBord
end
...
function MainViewTraceInfoPage:HandleEnterExpRaid()
  self.taskBord:Hide()
  self.expRaidBord:Show()
  self.curBord = self.expRaidBord
end
function MainViewTraceInfoPage:HandleExitExpRaid()
  self.taskBord:Show()
  self.expRaidBord:Hide()
  self.curBord = nil
end
