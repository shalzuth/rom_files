...
function SceneProxy:StartLoadFirst()
  if #self.LoadingScenes > 0 then
    ...
    if self.currentScene == nil then
      ...
      if nowMapRaid ~= nil and lastMapRaid ~= nil and lastMapRaid.Type == nowMapRaid.Type and nowMapRaid.Type == guildRaidType then
...
function SceneProxy:IsCurrentScene(sceneInfo)
  return (self.currentScene ~= nil and sceneInfo.mapID == self.currentScene.mapID and sceneInfo.dmapID == self.currentScene.dungeonMapId and SceneData.MapIDIsPVPMap(sceneInfo.mapID) == self.currentScene:IsPvPMap()) == true
end
