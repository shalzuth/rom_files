...
function CollectSaleConfirmPopUp:UpdateInfo()
  ...
  if not GameConfig.PackageMaterialCheck.quick_sell then
    local quick_sell = {1, 8}
  end
  for i = 1, #quick_sell do
    BagProxy.Instance:CollectQuickSaleItems(self.mt, quick_sell[i])
  end
