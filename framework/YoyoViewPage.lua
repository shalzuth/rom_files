...
function YoyoViewPage:GetClassifiedRoomData()
  ...
  local mapTab = {}
  if nil == RaidMap then
    helplog("\233\133\141\231\189\174\230\156\137\232\175\175\239\188\140\232\175\183\230\163\128\230\159\165\233\133\141\231\189\174\226\128\148\226\128\148> GameConfig.PVPConfig RaidMap ")
    return
  end
  for i = 1, #RaidMap do
