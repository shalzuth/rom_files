...
LocalSaveProxy.SAVE_KEY = {
	...
	Setting = "Setting",
	MainViewChatTweenLevel = "MainViewChatTweenLevel",	--主界面左下角聊天框大小
	MainViewAutoAimMonster = "MainViewAutoAimMonster",	--主界面右下角锁定魔物

	BossView_ShowMini = "BossView_ShowMini",

	SkipAnimation = "SkipAnimation",	--跳过动画
...
--"不再提示类的数据解析.DontShowAgain存储id，再由DontShowAgain_id为键值对应时间戳"
