...
function ProfessionTypeIconCell:NeedShowJinJie()
  ...
  if not ProfessionProxy.Instance:IsMPOpen() then
    if previousId == MyselfProxy.Instance:GetMyProfession() then
      ...
      if tiaojianlevel == nil then
        helplog("if tiaojianlevel == nil then \232\175\183\231\173\150\229\136\146\230\163\128\230\159\165\233\133\141\231\189\174\232\161\168")
        return false
      end
  ...
  if saveData and previousId and saveData.profession == previousId and thisBranch == saveData.branch and ProfessionProxy.Instance:GetCurTypeBranch() == thisBranch then
    ...
    if tiaojianlevel == nil then
      helplog("tiaojianlevel == nil \229\176\177\232\129\140\230\157\161\228\187\182\230\160\185\230\141\174\233\133\141\231\189\174\232\161\168 \230\142\168\230\181\139\228\184\141\229\135\186 \232\175\183\230\163\128\230\159\165\233\133\141\231\189\174\232\161\168")
      return false
    end
    if previouslevel == nil then
      helplog("if previouslevel == nil then")
...
function ProfessionTypeIconCell:ShowJinJie()
  ...
  self.name.text = "\232\191\155\233\152\182"
end
