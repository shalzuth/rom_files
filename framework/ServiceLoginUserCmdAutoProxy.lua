...
function ServiceLoginUserCmdAutoProxy:CallSnapShotUserCmd(data, lastselect, deletechar, deletecdtime, maincharid, area)
...
function ServiceLoginUserCmdAutoProxy:CallSelectRoleUserCmd(id, zoneID, accid, deviceid, name, version, extraData, ignorepwd, password, resettime, language, realauthorized, maxbaselv, pushkey, clickpos)
...
function ServiceLoginUserCmdAutoProxy:CallRefreshZoneIDUserCmd(charid, accid, zoneid)
