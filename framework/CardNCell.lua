...
function CardNCell:SetData(data)
  ...
  if data and data.cardInfo then
    ...
    if not PictureManager.Instance:SetCard(cardInfo.Picture, self.iconPic) then
      printRed(string.format("\228\184\186\230\137\190\229\136\176\229\144\141\228\184\186%s\231\154\132\229\141\161\231\137\135\232\181\132\230\186\144\227\128\130", cardInfo.Picture))
