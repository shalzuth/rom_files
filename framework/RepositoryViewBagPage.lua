...
function RepositoryViewBagPage:InitUI()
  ...
  self.itemlist = ItemNormalList.new(listObj, RepositoryBagCombineItemCell, nil, nil, true)
...
function RepositoryViewBagPage:ShowRepositoryItemTip(data, ignoreBounds)
  ...
  local callback = function()
    ...
    if itemdata and self.viewTab == RepositoryView.Tab.CommonTab and itemdata.equipInfo and itemdata.equipInfo.strengthlv > 0 then
