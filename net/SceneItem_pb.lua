...
ITEMPARAM.values = {ITEMPARAM_ITEMPARAM_PACKAGEITEM_ENUM,ITEMPARAM_ITEMPARAM_PACKAGEUPDATE_ENUM,ITEMPARAM_ITEMPARAM_ITEMUSE_ENUM,ITEMPARAM_ITEMPARAM_PACKAGESORT_ENUM,ITEMPARAM_ITEMPARAM_EQUIP_ENUM,ITEMPARAM_ITEMPARAM_SELLITEM_ENUM,ITEMPARAM_ITEMPARAM_EQUIPSTRENGTH_ENUM,ITEMPARAM_ITEMPARAM_PRODUCE_ENUM,ITEMPARAM_ITEMPARAM_PRODUCEDONE_ENUM,ITEMPARAM_ITEMPARAM_REFINE_ENUM,ITEMPARAM_ITEMPARAM_DECOMPOSE_ENUM,ITEMPARAM_ITEMPARAM_QUERYEQUIPDATA_ENUM,ITEMPARAM_ITEMPARAM_BROWSEPACK_ENUM,ITEMPARAM_ITEMPARAM_EQUIPCARD_ENUM,ITEMPARAM_ITEMPARAM_ITEMSHOW_ENUM,ITEMPARAM_ITEMPARAM_REPAIR_ENUM,ITEMPARAM_ITEMPARAM_HINTNTF_ENUM,ITEMPARAM_ITEMPARAM_ENCHANT_ENUM,ITEMPARAM_ITEMPARAM_PROCESSENCHANT_ENUM,ITEMPARAM_ITEMPARAM_EQUIPEXCHANGE_ENUM,ITEMPARAM_ITEMPARAM_ONOFFSTORE_ENUM,ITEMPARAM_ITEMPARAM_PACKSLOTNTF_ENUM,ITEMPARAM_ITEMPARAM_RESTOREEQUIP_ENUM,ITEMPARAM_ITEMPARAM_USECOUNT_ENUM,ITEMPARAM_ITEMPARAM_QUERYDECOMPOSERESULT_ENUM,ITEMPARAM_ITEMPARAM_EXCHANGECARD_ENUM,ITEMPARAM_ITEMPARAM_GETCOUNT_ENUM,ITEMPARAM_ITEMPARAM_SAVE_LOVE_LETTER_ENUM,ITEMPARAM_ITEMPARAM_ITEMDATASHOW_ENUM,ITEMPARAM_ITEMPARAM_LOTTERY_ENUM,ITEMPARAM_ITEMPARAM_LOTTERY_RECOVERY_ENUM,ITEMPARAM_ITEMPARAM_QUERY_LOTTERYINFO_ENUM,ITEMPARAM_ITEMPARAM_ITEMSHOW64_ENUM,ITEMPARAM_ITEMPARAM_HIGHREFINE_MATCOMPOSE_ENUM,ITEMPARAM_ITEMPARAM_HIGHREFINE_ENUM,ITEMPARAM_ITEMPARAM_NTF_HIGHTREFINE_DATA_ENUM,ITEMPARAM_ITEMPARAM_UPDATE_HIGHTREFINE_DATA_ENUM,ITEMPARAM_ITEMPARAM_REQ_QUOTA_LOG_ENUM,ITEMPARAM_ITEMPARAM_REQ_QUOTA_DETAIL_ENUM,ITEMPARAM_ITEMPARAM_EQUIPPOSDATA_UPDATE_ENUM,ITEMPARAM_ITEMPARAM_USE_CODE_ITEM_ENUM,ITEMPARAM_ITEMPARAM_ADD_JOBLEVEL_ENUM,ITEMPARAM_ITEMPARAM_LOTTERY_GIVE_BUY_COUNT_ENUM,ITEMPARAM_ITEMPARAM_GIVE_WEDDING_DRESS_ENUM,ITEMPARAM_ITEMPARAM_QUICK_STOREITEM_ENUM,ITEMPARAM_ITEMPARAM_QUICK_SELLITEM_ENUM,ITEMPARAM_ITEMPARAM_ENCHANT_TRANS_ENUM,ITEMPARAM_ITEMPARAM_QUERY_LOTTERYHEAD_ENUM,ITEMPARAM_ITEMPARAM_LOTTERY_RATE_QUERY_ENUM}
...
EPACKTYPE_EPACKTYPE_MAX_ENUM.index = 12
EPACKTYPE_EPACKTYPE_MAX_ENUM.number = 12
EPACKTYPE.name = "EPackType"
EPACKTYPE.full_name = ".Cmd.EPackType"
EPACKTYPE.values = {EPACKTYPE_EPACKTYPE_MIN_ENUM,EPACKTYPE_EPACKTYPE_MAIN_ENUM,EPACKTYPE_EPACKTYPE_EQUIP_ENUM,EPACKTYPE_EPACKTYPE_FASHION_ENUM,EPACKTYPE_EPACKTYPE_FASHIONEQUIP_ENUM,EPACKTYPE_EPACKTYPE_CARD_ENUM,EPACKTYPE_EPACKTYPE_STORE_ENUM,EPACKTYPE_EPACKTYPE_PERSONAL_STORE_ENUM,EPACKTYPE_EPACKTYPE_TEMP_MAIN_ENUM,EPACKTYPE_EPACKTYPE_BARROW_ENUM,EPACKTYPE_EPACKTYPE_QUEST_ENUM,EPACKTYPE_EPACKTYPE_FOOD_ENUM,EPACKTYPE_EPACKTYPE_MAX_ENUM}
...
EITEMTYPE_EITEMTYPE_ARTIFACT_INSTRUMEMT_ENUM.index = 90
...
EITEMTYPE_EITEMTYPE_ARTIFACT_WHIP_ENUM.index = 91
EITEMTYPE_EITEMTYPE_ARTIFACT_WHIP_ENUM.number = 460
EITEMTYPE_EITEMTYPE_ARTIFACT_HEAD_ENUM.name = "EITEMTYPE_ARTIFACT_HEAD"
EITEMTYPE_EITEMTYPE_ARTIFACT_HEAD_ENUM.index = 92
EITEMTYPE_EITEMTYPE_ARTIFACT_HEAD_ENUM.number = 485
EITEMTYPE_EITEMTYPE_ARTIFACT_BACK_ENUM.name = "EITEMTYPE_ARTIFACT_BACK"
EITEMTYPE_EITEMTYPE_ARTIFACT_BACK_ENUM.index = 93
EITEMTYPE_EITEMTYPE_ARTIFACT_BACK_ENUM.number = 488
EITEMTYPE_EITEMTYPE_ARMOUR_ENUM.name = "EITEMTYPE_ARMOUR"
EITEMTYPE_EITEMTYPE_ARMOUR_ENUM.index = 94
EITEMTYPE_EITEMTYPE_ARMOUR_ENUM.number = 500
EITEMTYPE_EITEMTYPE_ARMOUR_FASHION_ENUM.name = "EITEMTYPE_ARMOUR_FASHION"
EITEMTYPE_EITEMTYPE_ARMOUR_FASHION_ENUM.index = 95
EITEMTYPE_EITEMTYPE_ARMOUR_FASHION_ENUM.number = 501
EITEMTYPE_EITEMTYPE_SHIELD_ENUM.name = "EITEMTYPE_SHIELD"
EITEMTYPE_EITEMTYPE_SHIELD_ENUM.index = 96
EITEMTYPE_EITEMTYPE_SHIELD_ENUM.number = 510
EITEMTYPE_EITEMTYPE_PEARL_ENUM.name = "EITEMTYPE_PEARL"
EITEMTYPE_EITEMTYPE_PEARL_ENUM.index = 97
EITEMTYPE_EITEMTYPE_PEARL_ENUM.number = 511
EITEMTYPE_EITEMTYPE_EIKON_ENUM.name = "EITEMTYPE_EIKON"
EITEMTYPE_EITEMTYPE_EIKON_ENUM.index = 98
EITEMTYPE_EITEMTYPE_EIKON_ENUM.number = 512
EITEMTYPE_EITEMTYPE_BRACER_ENUM.name = "EITEMTYPE_BRACER"
EITEMTYPE_EITEMTYPE_BRACER_ENUM.index = 99
EITEMTYPE_EITEMTYPE_BRACER_ENUM.number = 513
EITEMTYPE_EITEMTYPE_BRACELET_ENUM.name = "EITEMTYPE_BRACELET"
EITEMTYPE_EITEMTYPE_BRACELET_ENUM.index = 100
EITEMTYPE_EITEMTYPE_BRACELET_ENUM.number = 514
EITEMTYPE_EITEMTYPE_TROLLEY_ENUM.name = "EITEMTYPE_TROLLEY"
EITEMTYPE_EITEMTYPE_TROLLEY_ENUM.index = 101
EITEMTYPE_EITEMTYPE_TROLLEY_ENUM.number = 515
EITEMTYPE_EITEMTYPE_ROBE_ENUM.name = "EITEMTYPE_ROBE"
EITEMTYPE_EITEMTYPE_ROBE_ENUM.index = 102
EITEMTYPE_EITEMTYPE_ROBE_ENUM.number = 520
EITEMTYPE_EITEMTYPE_SHOES_ENUM.name = "EITEMTYPE_SHOES"
EITEMTYPE_EITEMTYPE_SHOES_ENUM.index = 103
EITEMTYPE_EITEMTYPE_SHOES_ENUM.number = 530
EITEMTYPE_EITEMTYPE_ACCESSORY_ENUM.name = "EITEMTYPE_ACCESSORY"
EITEMTYPE_EITEMTYPE_ACCESSORY_ENUM.index = 104
EITEMTYPE_EITEMTYPE_ACCESSORY_ENUM.number = 540
EITEMTYPE_EITEMTYPE_FOOD_MEAT_ENUM.name = "EITEMTYPE_FOOD_MEAT"
EITEMTYPE_EITEMTYPE_FOOD_MEAT_ENUM.index = 105
EITEMTYPE_EITEMTYPE_FOOD_MEAT_ENUM.number = 601
EITEMTYPE_EITEMTYPE_FOOD_FISH_ENUM.name = "EITEMTYPE_FOOD_FISH"
EITEMTYPE_EITEMTYPE_FOOD_FISH_ENUM.index = 106
EITEMTYPE_EITEMTYPE_FOOD_FISH_ENUM.number = 602
EITEMTYPE_EITEMTYPE_FOOD_VEGETABLE_ENUM.name = "EITEMTYPE_FOOD_VEGETABLE"
EITEMTYPE_EITEMTYPE_FOOD_VEGETABLE_ENUM.index = 107
EITEMTYPE_EITEMTYPE_FOOD_VEGETABLE_ENUM.number = 603
EITEMTYPE_EITEMTYPE_FOOD_FRUIT_ENUM.name = "EITEMTYPE_FOOD_FRUIT"
EITEMTYPE_EITEMTYPE_FOOD_FRUIT_ENUM.index = 108
EITEMTYPE_EITEMTYPE_FOOD_FRUIT_ENUM.number = 604
EITEMTYPE_EITEMTYPE_FOOD_SEASONING_ENUM.name = "EITEMTYPE_FOOD_SEASONING"
EITEMTYPE_EITEMTYPE_FOOD_SEASONING_ENUM.index = 109
EITEMTYPE_EITEMTYPE_FOOD_SEASONING_ENUM.number = 605
EITEMTYPE_EITEMTYPE_FOOD_ENUM.name = "EITEMTYPE_FOOD"
EITEMTYPE_EITEMTYPE_FOOD_ENUM.index = 110
EITEMTYPE_EITEMTYPE_FOOD_ENUM.number = 610
EITEMTYPE_EITEMTYPE_HEAD_ENUM.name = "EITEMTYPE_HEAD"
EITEMTYPE_EITEMTYPE_HEAD_ENUM.index = 111
EITEMTYPE_EITEMTYPE_HEAD_ENUM.number = 800
EITEMTYPE_EITEMTYPE_BACK_ENUM.name = "EITEMTYPE_BACK"
EITEMTYPE_EITEMTYPE_BACK_ENUM.index = 112
EITEMTYPE_EITEMTYPE_BACK_ENUM.number = 810
EITEMTYPE_EITEMTYPE_HAIR_ENUM.name = "EITEMTYPE_HAIR"
EITEMTYPE_EITEMTYPE_HAIR_ENUM.index = 113
EITEMTYPE_EITEMTYPE_HAIR_ENUM.number = 820
EITEMTYPE_EITEMTYPE_HAIR_MALE_ENUM.name = "EITEMTYPE_HAIR_MALE"
EITEMTYPE_EITEMTYPE_HAIR_MALE_ENUM.index = 114
EITEMTYPE_EITEMTYPE_HAIR_MALE_ENUM.number = 821
EITEMTYPE_EITEMTYPE_HAIR_FEMALE_ENUM.name = "EITEMTYPE_HAIR_FEMALE"
EITEMTYPE_EITEMTYPE_HAIR_FEMALE_ENUM.index = 115
EITEMTYPE_EITEMTYPE_HAIR_FEMALE_ENUM.number = 822
EITEMTYPE_EITEMTYPE_EYE_MALE_ENUM.name = "EITEMTYPE_EYE_MALE"
EITEMTYPE_EITEMTYPE_EYE_MALE_ENUM.index = 116
EITEMTYPE_EITEMTYPE_EYE_MALE_ENUM.number = 823
EITEMTYPE_EITEMTYPE_EYE_FEMALE_ENUM.name = "EITEMTYPE_EYE_FEMALE"
EITEMTYPE_EITEMTYPE_EYE_FEMALE_ENUM.index = 117
EITEMTYPE_EITEMTYPE_EYE_FEMALE_ENUM.number = 824
EITEMTYPE_EITEMTYPE_FACE_ENUM.name = "EITEMTYPE_FACE"
EITEMTYPE_EITEMTYPE_FACE_ENUM.index = 118
EITEMTYPE_EITEMTYPE_FACE_ENUM.number = 830
EITEMTYPE_EITEMTYPE_TAIL_ENUM.name = "EITEMTYPE_TAIL"
EITEMTYPE_EITEMTYPE_TAIL_ENUM.index = 119
EITEMTYPE_EITEMTYPE_TAIL_ENUM.number = 840
EITEMTYPE_EITEMTYPE_MOUTH_ENUM.name = "EITEMTYPE_MOUTH"
EITEMTYPE_EITEMTYPE_MOUTH_ENUM.index = 120
EITEMTYPE_EITEMTYPE_MOUTH_ENUM.number = 850
EITEMTYPE_EITEMTYPE_WATER_ELEMENT_ENUM.name = "EITEMTYPE_WATER_ELEMENT"
EITEMTYPE_EITEMTYPE_WATER_ELEMENT_ENUM.index = 121
EITEMTYPE_EITEMTYPE_WATER_ELEMENT_ENUM.number = 1001
EITEMTYPE_EITEMTYPE_PORTRAIT_ENUM.name = "EITEMTYPE_PORTRAIT"
EITEMTYPE_EITEMTYPE_PORTRAIT_ENUM.index = 122
EITEMTYPE_EITEMTYPE_PORTRAIT_ENUM.number = 1200
EITEMTYPE_EITEMTYPE_FRAME_ENUM.name = "EITEMTYPE_FRAME"
EITEMTYPE_EITEMTYPE_FRAME_ENUM.index = 123
EITEMTYPE_EITEMTYPE_FRAME_ENUM.number = 1210
EITEMTYPE_EITEMTYPE_CODE_ENUM.name = "EITEMTYPE_CODE"
EITEMTYPE_EITEMTYPE_CODE_ENUM.index = 124
EITEMTYPE_EITEMTYPE_CODE_ENUM.number = 4000
EITEMTYPE_EITEMTYPE_KFC_CODE_ENUM.name = "EITEMTYPE_KFC_CODE"
EITEMTYPE_EITEMTYPE_KFC_CODE_ENUM.index = 125
EITEMTYPE_EITEMTYPE_KFC_CODE_ENUM.number = 4200
EITEMTYPE_EITEMTYPE_MAX_ENUM.name = "EITEMTYPE_MAX"
EITEMTYPE_EITEMTYPE_MAX_ENUM.index = 126
EITEMTYPE_EITEMTYPE_MAX_ENUM.number = 4201
EITEMTYPE.name = "EItemType"
EITEMTYPE.full_name = ".Cmd.EItemType"
EITEMTYPE.values = {EITEMTYPE_EITEMTYPE_MIN_ENUM,EITEMTYPE_EITEMTYPE_HONOR_ENUM,EITEMTYPE_EITEMTYPE_STREASURE_ENUM,EITEMTYPE_EITEMTYPE_TREASURE_ENUM,EITEMTYPE_EITEMTYPE_STUFF_ENUM,EITEMTYPE_EITEMTYPE_STUFFNOCUT_ENUM,EITEMTYPE_EITEMTYPE_ARROW_ENUM,EITEMTYPE_EITEMTYPE_USESKILL_ENUM,EITEMTYPE_EITEMTYPE_GHOSTLAMP_ENUM,EITEMTYPE_EITEMTYPE_MULTITIME_ENUM,EITEMTYPE_EITEMTYPE_MONTHCARD_ENUM,EITEMTYPE_EITEMTYPE_QUEST_ONCE_ENUM,EITEMTYPE_EITEMTYPE_QUEST_TIME_ENUM,EITEMTYPE_EITEMTYPE_SHEET_ENUM,EITEMTYPE_EITEMTYPE_CONSUME_ENUM,EITEMTYPE_EITEMTYPE_HAIRSTUFF_ENUM,EITEMTYPE_EITEMTYPE_CONSUME_2_ENUM,EITEMTYPE_EITEMTYPE_COLLECTION_ENUM,EITEMTYPE_EITEMTYPE_RANGE_ENUM,EITEMTYPE_EITEMTYPE_FUNCTION_ENUM,EITEMTYPE_EITEMTYPE_ACTIVITY_ENUM,EITEMTYPE_EITEMTYPE_WEDDING_RING_ENUM,EITEMTYPE_EITEMTYPE_MATERIAL_ENUM,EITEMTYPE_EITEMTYPE_LETTER_ENUM,EITEMTYPE_EITEMTYPE_GOLDAPPLE_ENUM,EITEMTYPE_EITEMTYPE_GETSKILL_ENUM,EITEMTYPE_EITEMTYPE_PICKEFFECT_ENUM,EITEMTYPE_EITEMTYPE_FRIEND_ENUM,EITEMTYPE_EITEMTYPE_PICKEFFECT_1_ENUM,EITEMTYPE_EITEMTYPE_CARD_WEAPON_ENUM,EITEMTYPE_EITEMTYPE_CARD_ASSIST_ENUM,EITEMTYPE_EITEMTYPE_CARD_ARMOUR_ENUM,EITEMTYPE_EITEMTYPE_CARD_ROBE_ENUM,EITEMTYPE_EITEMTYPE_CARD_SHOES_ENUM,EITEMTYPE_EITEMTYPE_CARD_ACCESSORY_ENUM,EITEMTYPE_EITEMTYPE_CARD_HEAD_ENUM,EITEMTYPE_EITEMTYPE_MOUNT_ENUM,EITEMTYPE_EITEMTYPE_BARROW_ENUM,EITEMTYPE_EITEMTYPE_PET_ENUM,EITEMTYPE_EITEMTYPE_EGG_ENUM,EITEMTYPE_EITEMTYPE_PET_EQUIP_ENUM,EITEMTYPE_EITEMTYPE_PET_CONSUME_ENUM,EITEMTYPE_EITEMTYPE_CARDPIECE_ENUM,EITEMTYPE_EITEMTYPE_EQUIPPIECE_ENUM,EITEMTYPE_EITEMTYPE_FASHION_PIECE_ENUM,EITEMTYPE_EITEMTYPE_GOLD_ENUM,EITEMTYPE_EITEMTYPE_SILVER_ENUM,EITEMTYPE_EITEMTYPE_DIAMOND_ENUM,EITEMTYPE_EITEMTYPE_GARDEN_ENUM,EITEMTYPE_EITEMTYPE_CONTRIBUTE_ENUM,EITEMTYPE_EITEMTYPE_ASSET_ENUM,EITEMTYPE_EITEMTYPE_FRIENDSHIP_ENUM,EITEMTYPE_EITEMTYPE_MANUALSPOINT_ENUM,EITEMTYPE_EITEMTYPE_MORA_ENUM,EITEMTYPE_EITEMTYPE_PVPCOIN_ENUM,EITEMTYPE_EITEMTYPE_BASEEXP_ENUM,EITEMTYPE_EITEMTYPE_JOBEXP_ENUM,EITEMTYPE_EITEMTYPE_PURIFY_ENUM,EITEMTYPE_EITEMTYPE_MANUALPOINT_ENUM,EITEMTYPE_EITEMTYPE_LOTTERY_ENUM,EITEMTYPE_EITEMTYPE_COOKER_EXP_ENUM,EITEMTYPE_EITEMTYPE_GUILDHONOR_ENUM,EITEMTYPE_EITEMTYPE_POLLY_COIN_ENUM,EITEMTYPE_EITEMTYPE_QUESTITEM_ENUM,EITEMTYPE_EITEMTYPE_QUESTITEMCOUNT_ENUM,EITEMTYPE_EITEMTYPE_WEDDING_CERT_ENUM,EITEMTYPE_EITEMTYPE_WEDDING_INVITE_ENUM,EITEMTYPE_EITEMTYPE_WEDDING_MANUAL_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_LANCE_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_SWORD_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_WAND_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_KNIFE_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_BOW_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_HAMMER_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_AXE_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_BOOK_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_DAGGER_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_INSTRUMEMT_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_WHIP_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_TUBE_ENUM,EITEMTYPE_EITEMTYPE_WEAPON_FIST_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_LANCE_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_SWORD_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_WAND_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_KNIFE_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_BOW_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_HAMMER_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_AXE_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_DAGGER_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_FIST_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_INSTRUMEMT_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_WHIP_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_HEAD_ENUM,EITEMTYPE_EITEMTYPE_ARTIFACT_BACK_ENUM,EITEMTYPE_EITEMTYPE_ARMOUR_ENUM,EITEMTYPE_EITEMTYPE_ARMOUR_FASHION_ENUM,EITEMTYPE_EITEMTYPE_SHIELD_ENUM,EITEMTYPE_EITEMTYPE_PEARL_ENUM,EITEMTYPE_EITEMTYPE_EIKON_ENUM,EITEMTYPE_EITEMTYPE_BRACER_ENUM,EITEMTYPE_EITEMTYPE_BRACELET_ENUM,EITEMTYPE_EITEMTYPE_TROLLEY_ENUM,EITEMTYPE_EITEMTYPE_ROBE_ENUM,EITEMTYPE_EITEMTYPE_SHOES_ENUM,EITEMTYPE_EITEMTYPE_ACCESSORY_ENUM,EITEMTYPE_EITEMTYPE_FOOD_MEAT_ENUM,EITEMTYPE_EITEMTYPE_FOOD_FISH_ENUM,EITEMTYPE_EITEMTYPE_FOOD_VEGETABLE_ENUM,EITEMTYPE_EITEMTYPE_FOOD_FRUIT_ENUM,EITEMTYPE_EITEMTYPE_FOOD_SEASONING_ENUM,EITEMTYPE_EITEMTYPE_FOOD_ENUM,EITEMTYPE_EITEMTYPE_HEAD_ENUM,EITEMTYPE_EITEMTYPE_BACK_ENUM,EITEMTYPE_EITEMTYPE_HAIR_ENUM,EITEMTYPE_EITEMTYPE_HAIR_MALE_ENUM,EITEMTYPE_EITEMTYPE_HAIR_FEMALE_ENUM,EITEMTYPE_EITEMTYPE_EYE_MALE_ENUM,EITEMTYPE_EITEMTYPE_EYE_FEMALE_ENUM,EITEMTYPE_EITEMTYPE_FACE_ENUM,EITEMTYPE_EITEMTYPE_TAIL_ENUM,EITEMTYPE_EITEMTYPE_MOUTH_ENUM,EITEMTYPE_EITEMTYPE_WATER_ELEMENT_ENUM,EITEMTYPE_EITEMTYPE_PORTRAIT_ENUM,EITEMTYPE_EITEMTYPE_FRAME_ENUM,EITEMTYPE_EITEMTYPE_CODE_ENUM,EITEMTYPE_EITEMTYPE_KFC_CODE_ENUM,EITEMTYPE_EITEMTYPE_MAX_ENUM}
...
EEQUIPTYPE.values = {EEQUIPTYPE_EEQUIPTYPE_MIN_ENUM,EEQUIPTYPE_EEQUIPTYPE_WEAPON_ENUM,EEQUIPTYPE_EEQUIPTYPE_SHIELD_ENUM,EEQUIPTYPE_EEQUIPTYPE_ARMOUR_ENUM,EEQUIPTYPE_EEQUIPTYPE_ROBE_ENUM,EEQUIPTYPE_EEQUIPTYPE_SHOES_ENUM,EEQUIPTYPE_EEQUIPTYPE_ACCESSORY_ENUM,EEQUIPTYPE_EEQUIPTYPE_HEAD_ENUM,EEQUIPTYPE_EEQUIPTYPE_BACK_ENUM,EEQUIPTYPE_EEQUIPTYPE_FACE_ENUM,EEQUIPTYPE_EEQUIPTYPE_TAIL_ENUM,EEQUIPTYPE_EEQUIPTYPE_MOUNT_ENUM,EEQUIPTYPE_EEQUIPTYPE_MOUTH_ENUM,EEQUIPTYPE_EEQUIPTYPE_BARROW_ENUM,EEQUIPTYPE_EEQUIPTYPE_PEARL_ENUM,EEQUIPTYPE_EEQUIPTYPE_EIKON_ENUM,EEQUIPTYPE_EEQUIPTYPE_BRACELET_ENUM,EEQUIPTYPE_EEQUIPTYPE_HANDBRACELET_ENUM,EEQUIPTYPE_EEQUIPTYPE_TROLLEY_ENUM,EEQUIPTYPE_EEQUIPTYPE_ARTIFACT_ENUM,EEQUIPTYPE_EEQUIPTYPE_ARTIFACT_HEAD_ENUM,EEQUIPTYPE_EEQUIPTYPE_ARTIFACT_BACK_ENUM,EEQUIPTYPE_EEQUIPTYPE_MAX_ENUM}
...
EBINDTYPE.values = {EBINDTYPE_EBINDTYPE_MIN_ENUM,EBINDTYPE_EBINDTYPE_BIND_ENUM,EBINDTYPE_EBINDTYPE_NOBIND_ENUM,EBINDTYPE_EBINDTYPE_MAX_ENUM}
...
EEXPIRETYPE.values = {EEXPIRETYPE_EEXPIRETYPE_MIN_ENUM,EEXPIRETYPE_EEXPIRETYPE_MAX_ENUM}
...
ERIDETYPE.values = {ERIDETYPE_ERIDETYPE_MIN_ENUM,ERIDETYPE_ERIDETYPE_ON_ENUM,ERIDETYPE_ERIDETYPE_OFF_ENUM,ERIDETYPE_ERIDETYPE_MAX_ENUM}
...
ETRAGETTYPE.values = {ETRAGETTYPE_ETARGETTYPE_MY_ENUM,ETRAGETTYPE_ETARGETTYPE_USER_ENUM,ETRAGETTYPE_ETARGETTYPE_MONSTER_ENUM,ETRAGETTYPE_ETARGETTYPE_USERANDMONSTER_ENUM}
...
EENCHANTTYPE.values = {EENCHANTTYPE_EENCHANTTYPE_MIN_ENUM,EENCHANTTYPE_EENCHANTTYPE_PRIMARY_ENUM,EENCHANTTYPE_EENCHANTTYPE_MEDIUM_ENUM,EENCHANTTYPE_EENCHANTTYPE_SENIOR_ENUM,EENCHANTTYPE_EENCHANTTYPE_MAX_ENUM}
...
ELETTERTYPE.values = {ELETTERTYPE_ELETTERTYPE_LOVE_ENUM,ELETTERTYPE_ELETTERTYPE_CONSTELLATION_ENUM,ELETTERTYPE_ELETTERTYPE_CHRISTMAS_ENUM,ELETTERTYPE_ELETTERTYPE_SPRING_ENUM,ELETTERTYPE_ELETTERTYPE_LOTTERY_ENUM,ELETTERTYPE_ELETTERTYPE_WEDDINGDRESS_ENUM}
...
EEQUIPOPER_EEQUIPOPER_MAX_ENUM.index = 14
EEQUIPOPER_EEQUIPOPER_MAX_ENUM.number = 14
EEQUIPOPER.name = "EEquipOper"
EEQUIPOPER.full_name = ".Cmd.EEquipOper"
EEQUIPOPER.values = {EEQUIPOPER_EEQUIPOPER_MIN_ENUM,EEQUIPOPER_EEQUIPOPER_ON_ENUM,EEQUIPOPER_EEQUIPOPER_OFF_ENUM,EEQUIPOPER_EEQUIPOPER_PUTFASHION_ENUM,EEQUIPOPER_EEQUIPOPER_OFFFASHION_ENUM,EEQUIPOPER_EEQUIPOPER_PUTSTORE_ENUM,EEQUIPOPER_EEQUIPOPER_OFFSTORE_ENUM,EEQUIPOPER_EEQUIPOPER_OFFALL_ENUM,EEQUIPOPER_EEQUIPOPER_OFFPOS_ENUM,EEQUIPOPER_EEQUIPOPER_PUTPSTORE_ENUM,EEQUIPOPER_EEQUIPOPER_OFFPSTORE_ENUM,EEQUIPOPER_EEQUIPOPER_OFFTEMP_ENUM,EEQUIPOPER_EEQUIPOPER_PUTBARROW_ENUM,EEQUIPOPER_EEQUIPOPER_OFFBARROW_ENUM,EEQUIPOPER_EEQUIPOPER_MAX_ENUM}
...
EEQUIPPOS.values = {EEQUIPPOS_EEQUIPPOS_MIN_ENUM,EEQUIPPOS_EEQUIPPOS_WEAPON_ENUM,EEQUIPPOS_EEQUIPPOS_ARMOUR_ENUM,EEQUIPPOS_EEQUIPPOS_SHIELD_ENUM,EEQUIPPOS_EEQUIPPOS_ROBE_ENUM,EEQUIPPOS_EEQUIPPOS_SHOES_ENUM,EEQUIPPOS_EEQUIPPOS_ACCESSORY1_ENUM,EEQUIPPOS_EEQUIPPOS_ACCESSORY2_ENUM,EEQUIPPOS_EEQUIPPOS_HEAD_ENUM,EEQUIPPOS_EEQUIPPOS_BACK_ENUM,EEQUIPPOS_EEQUIPPOS_FACE_ENUM,EEQUIPPOS_EEQUIPPOS_TAIL_ENUM,EEQUIPPOS_EEQUIPPOS_MOUNT_ENUM,EEQUIPPOS_EEQUIPPOS_MOUTH_ENUM,EEQUIPPOS_EEQUIPPOS_BARROW_ENUM,EEQUIPPOS_EEQUIPPOS_ARTIFACT_ENUM,EEQUIPPOS_EEQUIPPOS_ARTIFACT_HEAD_ENUM,EEQUIPPOS_EEQUIPPOS_ARTIFACT_BACK_ENUM,EEQUIPPOS_EEQUIPPOS_MAX_ENUM}
...
ESTRENGTHRESULT.values = {ESTRENGTHRESULT_ESTRENGTHRESULT_MIN_ENUM,ESTRENGTHRESULT_ESTRENGTHRESULT_SUCCESS_ENUM,ESTRENGTHRESULT_ESTRENGTHRESULT_NOMATERIAL_ENUM,ESTRENGTHRESULT_ESTRENGTHRESULT_MAXLV_ENUM}
...
ESTRENGTHTYPE.values = {ESTRENGTHTYPE_ESTRENGTHTYPE_MIN_ENUM,ESTRENGTHTYPE_ESTRENGTHTYPE_NORMAL_ENUM,ESTRENGTHTYPE_ESTRENGTHTYPE_GUILD_ENUM,ESTRENGTHTYPE_ESTRENGTHTYPE_MAX_ENUM}
...
EPRODUCETYPE.values = {EPRODUCETYPE_EPRODUCETYPE_MIN_ENUM,EPRODUCETYPE_EPRODUCETYPE_HEAD_ENUM,EPRODUCETYPE_EPRODUCETYPE_EQUIP_ENUM,EPRODUCETYPE_EPRODUCETYPE_TRADER_ENUM,EPRODUCETYPE_EPRODUCETYPE_MAX_ENUM}
...
EREFINERESULT.values = {EREFINERESULT_EREFINERESULT_MIN_ENUM,EREFINERESULT_EREFINERESULT_SUCCESS_ENUM,EREFINERESULT_EREFINERESULT_FAILSTAY_ENUM,EREFINERESULT_EREFINERESULT_FAILBACK_ENUM,EREFINERESULT_EREFINERESULT_FAILSTAYDAM_ENUM,EREFINERESULT_EREFINERESULT_FAILBACKDAM_ENUM,EREFINERESULT_EREFINERESULT_MAX_ENUM}
...
EDECOMPOSERESULT.values = {EDECOMPOSERESULT_EDECOMPOSERESULT_MIN_ENUM,EDECOMPOSERESULT_EDECOMPOSERESULT_FAIL_ENUM,EDECOMPOSERESULT_EDECOMPOSERESULT_SUCCESS_ENUM,EDECOMPOSERESULT_EDECOMPOSERESULT_SUCCESS_BIG_ENUM,EDECOMPOSERESULT_EDECOMPOSERESULT_SUCCESS_SBIG_ENUM,EDECOMPOSERESULT_EDECOMPOSERESULT_SUCCESS_FANTASY_ENUM,EDECOMPOSERESULT_EDECOMPOSERESULT_MAX_ENUM}
...
ECARDOPER.values = {ECARDOPER_ECARDOPER_MIN_ENUM,ECARDOPER_ECARDOPER_EQUIPON_ENUM,ECARDOPER_ECARDOPER_EQUIPOFF_ENUM,ECARDOPER_ECARDOPER_MAX_ENUM}
...
ETRADETYPE.values = {ETRADETYPE_ETRADETYPE_ALL_ENUM,ETRADETYPE_ETRADETYPE_TRADE_ENUM,ETRADETYPE_ETRADETYPE_BOOTH_ENUM}
...
EEXCHANGETYPE.values = {EEXCHANGETYPE_EEXCHANGETYPE_MIN_ENUM,EEXCHANGETYPE_EEXCHANGETYPE_EXCHANGE_ENUM,EEXCHANGETYPE_EEXCHANGETYPE_LEVELUP_ENUM,EEXCHANGETYPE_EEXCHANGETYPE_MAX_ENUM}
...
EEXCHANGECARDTYPE.values = {EEXCHANGECARDTYPE_EEXCHANGECARDTYPE_DRAW_ENUM,EEXCHANGECARDTYPE_EEXCHANGECARDTYPE_COMPOSE_ENUM,EEXCHANGECARDTYPE_EEXCHANGECARDTYPE_DECOMPOSE_ENUM}
...
ELOTTERYTYPE_ELOTTERYTYPE_MAX_ENUM.index = 6
ELOTTERYTYPE_ELOTTERYTYPE_MAX_ENUM.number = 6
ELOTTERYTYPE.name = "ELotteryType"
ELOTTERYTYPE.full_name = ".Cmd.ELotteryType"
ELOTTERYTYPE.values = {ELOTTERYTYPE_ELOTTERYTYPE_MIN_ENUM,ELOTTERYTYPE_ELOTTERYTYPE_HEAD_ENUM,ELOTTERYTYPE_ELOTTERYTYPE_EQUIP_ENUM,ELOTTERYTYPE_ELOTTERYTYPE_CARD_ENUM,ELOTTERYTYPE_ELOTTERYTYPE_CATLITTERBOX_ENUM,ELOTTERYTYPE_ELOTTERYTYPE_MAGIC_ENUM,ELOTTERYTYPE_ELOTTERYTYPE_MAX_ENUM}
...
EQUOTATYPE_EQUOTATYPE_L_CHARGE_ENUM.index = 10
EQUOTATYPE_EQUOTATYPE_L_CHARGE_ENUM.number = 20
EQUOTATYPE_EQUOTATYPE_U_CHARGE_ENUM.name = "EQuotaType_U_Charge"
EQUOTATYPE_EQUOTATYPE_U_CHARGE_ENUM.index = 11
EQUOTATYPE_EQUOTATYPE_U_CHARGE_ENUM.number = 21
EQUOTATYPE.name = "EQuotaType"
EQUOTATYPE.full_name = ".Cmd.EQuotaType"
EQUOTATYPE.values = {EQUOTATYPE_EQUOTATYPE_G_CHARGE_ENUM,EQUOTATYPE_EQUOTATYPE_C_GIVE_ENUM,EQUOTATYPE_EQUOTATYPE_C_AUCTION_ENUM,EQUOTATYPE_EQUOTATYPE_G_AUCTION_ENUM,EQUOTATYPE_EQUOTATYPE_C_LOTTERY_ENUM,EQUOTATYPE_EQUOTATYPE_C_GUILDBOX_ENUM,EQUOTATYPE_EQUOTATYPE_C_WEDDINGDRESS_ENUM,EQUOTATYPE_EQUOTATYPE_L_BOOTH_ENUM,EQUOTATYPE_EQUOTATYPE_U_BOOTH_ENUM,EQUOTATYPE_EQUOTATYPE_C_BOOTH_ENUM,EQUOTATYPE_EQUOTATYPE_L_CHARGE_ENUM,EQUOTATYPE_EQUOTATYPE_U_CHARGE_ENUM}
...
ITEMINFO.enum_types = {}
ITEMINFO.fields = {ITEMINFO_GUID_FIELD, ITEMINFO_ID_FIELD, ITEMINFO_COUNT_FIELD, ITEMINFO_INDEX_FIELD, ITEMINFO_CREATETIME_FIELD, ITEMINFO_CD_FIELD, ITEMINFO_TYPE_FIELD, ITEMINFO_BIND_FIELD, ITEMINFO_EXPIRE_FIELD, ITEMINFO_QUALITY_FIELD, ITEMINFO_EQUIPTYPE_FIELD, ITEMINFO_SOURCE_FIELD, ITEMINFO_ISNEW_FIELD, ITEMINFO_MAXCARDSLOT_FIELD, ITEMINFO_ISHINT_FIELD, ITEMINFO_ISACTIVE_FIELD, ITEMINFO_SOURCE_NPC_FIELD, ITEMINFO_REFINELV_FIELD, ITEMINFO_CHARGEMONEY_FIELD, ITEMINFO_OVERTIME_FIELD, ITEMINFO_QUOTA_FIELD}
...
REFINECOMPOSE.fields = {REFINECOMPOSE_ID_FIELD, REFINECOMPOSE_NUM_FIELD}
...
EQUIPDATA.fields = {EQUIPDATA_STRENGTHLV_FIELD, EQUIPDATA_REFINELV_FIELD, EQUIPDATA_STRENGTHCOST_FIELD, EQUIPDATA_REFINECOMPOSE_FIELD, EQUIPDATA_CARDSLOT_FIELD, EQUIPDATA_BUFFID_FIELD, EQUIPDATA_DAMAGE_FIELD, EQUIPDATA_LV_FIELD, EQUIPDATA_COLOR_FIELD, EQUIPDATA_BREAKSTARTTIME_FIELD, EQUIPDATA_BREAKENDTIME_FIELD, EQUIPDATA_STRENGTHLV2_FIELD, EQUIPDATA_STRENGTHLV2COST_FIELD}
...
CARDDATA.enum_types = {}
CARDDATA.fields = {CARDDATA_GUID_FIELD, CARDDATA_ID_FIELD, CARDDATA_POS_FIELD}
...
ENCHANTATTR.fields = {ENCHANTATTR_TYPE_FIELD, ENCHANTATTR_VALUE_FIELD}
...
ENCHANTEXTRA.fields = {ENCHANTEXTRA_CONFIGID_FIELD, ENCHANTEXTRA_BUFFID_FIELD}
...
ENCHANTDATA.fields = {ENCHANTDATA_TYPE_FIELD, ENCHANTDATA_ATTRS_FIELD, ENCHANTDATA_EXTRAS_FIELD, ENCHANTDATA_PATCH_FIELD}
...
REFINEDATA.fields = {REFINEDATA_LASTFAIL_FIELD, REFINEDATA_REPAIRCOUNT_FIELD}
...
EGGEQUIP.enum_types = {}
EGGEQUIP.fields = {EGGEQUIP_BASE_FIELD, EGGEQUIP_DATA_FIELD, EGGEQUIP_CARD_FIELD, EGGEQUIP_ENCHANT_FIELD, EGGEQUIP_PREVIEWENCHANT_FIELD, EGGEQUIP_REFINE_FIELD}
...
EGGDATA.enum_types = {}
EGGDATA.fields = {EGGDATA_EXP_FIELD, EGGDATA_FRIENDEXP_FIELD, EGGDATA_REWARDEXP_FIELD, EGGDATA_ID_FIELD, EGGDATA_LV_FIELD, EGGDATA_FRIENDLV_FIELD, EGGDATA_BODY_FIELD, EGGDATA_RELIVETIME_FIELD, EGGDATA_HP_FIELD, EGGDATA_RESTORETIME_FIELD, EGGDATA_TIME_HAPPLY_FIELD, EGGDATA_TIME_EXCITE_FIELD, EGGDATA_TIME_HAPPINESS_FIELD, EGGDATA_TIME_HAPPLY_GIFT_FIELD, EGGDATA_TIME_EXCITE_GIFT_FIELD, EGGDATA_TIME_HAPPINESS_GIFT_FIELD, EGGDATA_TOUCH_TICK_FIELD, EGGDATA_FEED_TICK_FIELD, EGGDATA_NAME_FIELD, EGGDATA_VAR_FIELD, EGGDATA_SKILLIDS_FIELD, EGGDATA_EQUIPS_FIELD, EGGDATA_BUFF_FIELD, EGGDATA_UNLOCK_EQUIP_FIELD, EGGDATA_UNLOCK_BODY_FIELD, EGGDATA_VERSION_FIELD, EGGDATA_SKILLOFF_FIELD, EGGDATA_EXCHANGE_COUNT_FIELD, EGGDATA_GUID_FIELD}
...
LOVELETTERDATA.fields = {LOVELETTERDATA_SENDUSERNAME_FIELD, LOVELETTERDATA_BG_FIELD, LOVELETTERDATA_CONFIGID_FIELD, LOVELETTERDATA_CONTENT_FIELD, LOVELETTERDATA_CONTENT2_FIELD}
...
CODEDATA.enum_types = {}
CODEDATA.fields = {CODEDATA_CODE_FIELD, CODEDATA_USED_FIELD}
...
WEDDINGDATA.fields = {WEDDINGDATA_ID_FIELD, WEDDINGDATA_ZONEID_FIELD, WEDDINGDATA_CHARID1_FIELD, WEDDINGDATA_CHARID2_FIELD, WEDDINGDATA_WEDDINGTIME_FIELD, WEDDINGDATA_PHOTOIDX_FIELD, WEDDINGDATA_PHOTOTIME_FIELD, WEDDINGDATA_MYNAME_FIELD, WEDDINGDATA_PARTNERNAME_FIELD, WEDDINGDATA_STARTTIME_FIELD, WEDDINGDATA_ENDTIME_FIELD, WEDDINGDATA_NOTIFIED_FIELD}
...
SENDERDATA.fields = {SENDERDATA_CHARID_FIELD, SENDERDATA_NAME_FIELD}
...
ITEMDATA.enum_types = {}
ITEMDATA.fields = {ITEMDATA_BASE_FIELD, ITEMDATA_EQUIPED_FIELD, ITEMDATA_BATTLEPOINT_FIELD, ITEMDATA_EQUIP_FIELD, ITEMDATA_CARD_FIELD, ITEMDATA_ENCHANT_FIELD, ITEMDATA_PREVIEWENCHANT_FIELD, ITEMDATA_REFINE_FIELD, ITEMDATA_EGG_FIELD, ITEMDATA_LETTER_FIELD, ITEMDATA_CODE_FIELD, ITEMDATA_WEDDING_FIELD, ITEMDATA_SENDER_FIELD}
...
PACKAGEITEM.fields = {PACKAGEITEM_CMD_FIELD, PACKAGEITEM_PARAM_FIELD, PACKAGEITEM_TYPE_FIELD, PACKAGEITEM_DATA_FIELD, PACKAGEITEM_MAXSLOT_FIELD}
...
PACKAGEUPDATE.fields = {PACKAGEUPDATE_CMD_FIELD, PACKAGEUPDATE_PARAM_FIELD, PACKAGEUPDATE_TYPE_FIELD, PACKAGEUPDATE_UPDATEITEMS_FIELD, PACKAGEUPDATE_DELITEMS_FIELD}
...
ITEMUSE.enum_types = {}
ITEMUSE.fields = {ITEMUSE_CMD_FIELD, ITEMUSE_PARAM_FIELD, ITEMUSE_ITEMGUID_FIELD, ITEMUSE_TARGETS_FIELD, ITEMUSE_COUNT_FIELD}
...
SORTINFO.enum_types = {}
SORTINFO.fields = {SORTINFO_GUID_FIELD, SORTINFO_INDEX_FIELD}
...
PACKAGESORT.fields = {PACKAGESORT_CMD_FIELD, PACKAGESORT_PARAM_FIELD, PACKAGESORT_TYPE_FIELD, PACKAGESORT_ITEM_FIELD}
...
EQUIP.nested_types = {}
EQUIP.enum_types = {}
EQUIP.fields = {EQUIP_CMD_FIELD, EQUIP_PARAM_FIELD, EQUIP_OPER_FIELD, EQUIP_POS_FIELD, EQUIP_GUID_FIELD, EQUIP_TRANSFER_FIELD, EQUIP_COUNT_FIELD}
...
SITEM.nested_types = {}
SITEM.enum_types = {}
SITEM.fields = {SITEM_GUID_FIELD, SITEM_COUNT_FIELD}
...
SELLITEM.enum_types = {}
SELLITEM.fields = {SELLITEM_CMD_FIELD, SELLITEM_PARAM_FIELD, SELLITEM_NPCID_FIELD, SELLITEM_ITEMS_FIELD}
...
EQUIPSTRENGTH.fields = {EQUIPSTRENGTH_CMD_FIELD, EQUIPSTRENGTH_PARAM_FIELD, EQUIPSTRENGTH_GUID_FIELD, EQUIPSTRENGTH_DESTCOUNT_FIELD, EQUIPSTRENGTH_COUNT_FIELD, EQUIPSTRENGTH_CRICOUNT_FIELD, EQUIPSTRENGTH_OLDLV_FIELD, EQUIPSTRENGTH_NEWLV_FIELD, EQUIPSTRENGTH_RESULT_FIELD, EQUIPSTRENGTH_TYPE_FIELD}
...
PRODUCE.enum_types = {}
PRODUCE.fields = {PRODUCE_CMD_FIELD, PRODUCE_PARAM_FIELD, PRODUCE_TYPE_FIELD, PRODUCE_COMPOSEID_FIELD, PRODUCE_NPCID_FIELD, PRODUCE_ITEMID_FIELD, PRODUCE_COUNT_FIELD, PRODUCE_QUCIKPRODUCE_FIELD}
...
PRODUCEDONE.fields = {PRODUCEDONE_CMD_FIELD, PRODUCEDONE_PARAM_FIELD, PRODUCEDONE_TYPE_FIELD, PRODUCEDONE_NPCID_FIELD, PRODUCEDONE_CHARID_FIELD, PRODUCEDONE_DELAY_FIELD, PRODUCEDONE_ITEMID_FIELD}
...
EQUIPREFINE.fields = {EQUIPREFINE_CMD_FIELD, EQUIPREFINE_PARAM_FIELD, EQUIPREFINE_GUID_FIELD, EQUIPREFINE_COMPOSEID_FIELD, EQUIPREFINE_REFINELV_FIELD, EQUIPREFINE_ERESULT_FIELD, EQUIPREFINE_NPCID_FIELD, EQUIPREFINE_SAFEREFINE_FIELD, EQUIPREFINE_ITEMGUID_FIELD}
...
EQUIPDECOMPOSE.fields = {EQUIPDECOMPOSE_CMD_FIELD, EQUIPDECOMPOSE_PARAM_FIELD, EQUIPDECOMPOSE_GUID_FIELD, EQUIPDECOMPOSE_RESULT_FIELD, EQUIPDECOMPOSE_ITEMS_FIELD}
...
DECOMPOSERESULT.fields = {DECOMPOSERESULT_ITEM_FIELD, DECOMPOSERESULT_RATE_FIELD, DECOMPOSERESULT_MIN_COUNT_FIELD, DECOMPOSERESULT_MAX_COUNT_FIELD}
...
QUERYDECOMPOSERESULTITEMCMD.fields = {QUERYDECOMPOSERESULTITEMCMD_CMD_FIELD, QUERYDECOMPOSERESULTITEMCMD_PARAM_FIELD, QUERYDECOMPOSERESULTITEMCMD_GUID_FIELD, QUERYDECOMPOSERESULTITEMCMD_RESULTS_FIELD, QUERYDECOMPOSERESULTITEMCMD_SELL_PRICE_FIELD}
...
QUERYEQUIPDATA.fields = {QUERYEQUIPDATA_CMD_FIELD, QUERYEQUIPDATA_PARAM_FIELD, QUERYEQUIPDATA_GUID_FIELD, QUERYEQUIPDATA_DATA_FIELD}
...
BROWSEPACKAGE.fields = {BROWSEPACKAGE_CMD_FIELD, BROWSEPACKAGE_PARAM_FIELD, BROWSEPACKAGE_TYPE_FIELD}
...
EQUIPCARD.fields = {EQUIPCARD_CMD_FIELD, EQUIPCARD_PARAM_FIELD, EQUIPCARD_OPER_FIELD, EQUIPCARD_CARDGUID_FIELD, EQUIPCARD_EQUIPGUID_FIELD, EQUIPCARD_POS_FIELD}
...
ITEMSHOW.enum_types = {}
ITEMSHOW.fields = {ITEMSHOW_CMD_FIELD, ITEMSHOW_PARAM_FIELD, ITEMSHOW_ITEMS_FIELD}
...
ITEMSHOW64.fields = {ITEMSHOW64_CMD_FIELD, ITEMSHOW64_PARAM_FIELD, ITEMSHOW64_ID_FIELD, ITEMSHOW64_COUNT_FIELD}
...
EQUIPREPAIR.fields = {EQUIPREPAIR_CMD_FIELD, EQUIPREPAIR_PARAM_FIELD, EQUIPREPAIR_TARGETGUID_FIELD, EQUIPREPAIR_SUCCESS_FIELD, EQUIPREPAIR_STUFFGUID_FIELD}
...
HINTNTF.enum_types = {}
HINTNTF.fields = {HINTNTF_CMD_FIELD, HINTNTF_PARAM_FIELD, HINTNTF_ITEMID_FIELD}
...
ENCHANTEQUIP.fields = {ENCHANTEQUIP_CMD_FIELD, ENCHANTEQUIP_PARAM_FIELD, ENCHANTEQUIP_TYPE_FIELD, ENCHANTEQUIP_GUID_FIELD}
...
TRADECOMPOSEPAIR.fields = {TRADECOMPOSEPAIR_COMPOSE_ID_FIELD, TRADECOMPOSEPAIR_COUNT_FIELD}
...
TRADEREFINEDATA.fields = {TRADEREFINEDATA_COMPOSEINFOS_FIELD}
...
TRADEITEMBASEINFO_PRICE_FIELD.type = 13
TRADEITEMBASEINFO_PRICE_FIELD.cpp_type = 3
...
TRADEITEMBASEINFO.fields = {TRADEITEMBASEINFO_ITEMID_FIELD, TRADEITEMBASEINFO_PRICE_FIELD, TRADEITEMBASEINFO_COUNT_FIELD, TRADEITEMBASEINFO_GUID_FIELD, TRADEITEMBASEINFO_ORDER_ID_FIELD, TRADEITEMBASEINFO_REFINE_LV_FIELD, TRADEITEMBASEINFO_OVERLAP_FIELD, TRADEITEMBASEINFO_IS_EXPIRED_FIELD, TRADEITEMBASEINFO_ITEM_DATA_FIELD, TRADEITEMBASEINFO_PUBLICITY_ID_FIELD, TRADEITEMBASEINFO_END_TIME_FIELD, TRADEITEMBASEINFO_KEY_FIELD, TRADEITEMBASEINFO_CHARID_FIELD, TRADEITEMBASEINFO_NAME_FIELD, TRADEITEMBASEINFO_TYPE_FIELD, TRADEITEMBASEINFO_UP_RATE_FIELD, TRADEITEMBASEINFO_DOWN_RATE_FIELD}
...
PROCESSENCHANTITEMCMD.fields = {PROCESSENCHANTITEMCMD_CMD_FIELD, PROCESSENCHANTITEMCMD_PARAM_FIELD, PROCESSENCHANTITEMCMD_SAVE_FIELD, PROCESSENCHANTITEMCMD_ITEMID_FIELD}
...
EQUIPEXCHANGEITEMCMD.fields = {EQUIPEXCHANGEITEMCMD_CMD_FIELD, EQUIPEXCHANGEITEMCMD_PARAM_FIELD, EQUIPEXCHANGEITEMCMD_GUID_FIELD, EQUIPEXCHANGEITEMCMD_TYPE_FIELD}
...
ONOFFSTOREITEMCMD.fields = {ONOFFSTOREITEMCMD_CMD_FIELD, ONOFFSTOREITEMCMD_PARAM_FIELD, ONOFFSTOREITEMCMD_OPEN_FIELD}
...
PACKSLOTNTFITEMCMD.fields = {PACKSLOTNTFITEMCMD_CMD_FIELD, PACKSLOTNTFITEMCMD_PARAM_FIELD, PACKSLOTNTFITEMCMD_TYPE_FIELD, PACKSLOTNTFITEMCMD_MAXSLOT_FIELD}
...
RESTOREEQUIPITEMCMD.fields = {RESTOREEQUIPITEMCMD_CMD_FIELD, RESTOREEQUIPITEMCMD_PARAM_FIELD, RESTOREEQUIPITEMCMD_EQUIPID_FIELD, RESTOREEQUIPITEMCMD_STRENGTHLV_FIELD, RESTOREEQUIPITEMCMD_CARDIDS_FIELD, RESTOREEQUIPITEMCMD_ENCHANT_FIELD, RESTOREEQUIPITEMCMD_UPGRADE_FIELD, RESTOREEQUIPITEMCMD_STRENGTHLV2_FIELD}
...
USECOUNTITEMCMD.fields = {USECOUNTITEMCMD_CMD_FIELD, USECOUNTITEMCMD_PARAM_FIELD, USECOUNTITEMCMD_ITEMID_FIELD, USECOUNTITEMCMD_COUNT_FIELD}
...
EXCHANGECARDITEMCMD.fields = {EXCHANGECARDITEMCMD_CMD_FIELD, EXCHANGECARDITEMCMD_PARAM_FIELD, EXCHANGECARDITEMCMD_TYPE_FIELD, EXCHANGECARDITEMCMD_NPCID_FIELD, EXCHANGECARDITEMCMD_MATERIAL_FIELD, EXCHANGECARDITEMCMD_CHARID_FIELD, EXCHANGECARDITEMCMD_CARDID_FIELD, EXCHANGECARDITEMCMD_ANIM_FIELD, EXCHANGECARDITEMCMD_ITEMS_FIELD}
...
GETCOUNTITEMCMD.fields = {GETCOUNTITEMCMD_CMD_FIELD, GETCOUNTITEMCMD_PARAM_FIELD, GETCOUNTITEMCMD_ITEMID_FIELD, GETCOUNTITEMCMD_COUNT_FIELD, GETCOUNTITEMCMD_SOURCE_FIELD}
...
SAVELOVELETTERCMD.fields = {SAVELOVELETTERCMD_CMD_FIELD, SAVELOVELETTERCMD_PARAM_FIELD, SAVELOVELETTERCMD_DWID_FIELD}
...
ITEMDATASHOW.fields = {ITEMDATASHOW_CMD_FIELD, ITEMDATASHOW_PARAM_FIELD, ITEMDATASHOW_ITEMS_FIELD}
...
LOTTERYCMD.fields = {LOTTERYCMD_CMD_FIELD, LOTTERYCMD_PARAM_FIELD, LOTTERYCMD_YEAR_FIELD, LOTTERYCMD_MONTH_FIELD, LOTTERYCMD_NPCID_FIELD, LOTTERYCMD_SKIP_ANIM_FIELD, LOTTERYCMD_PRICE_FIELD, LOTTERYCMD_TICKET_FIELD, LOTTERYCMD_TYPE_FIELD, LOTTERYCMD_COUNT_FIELD, LOTTERYCMD_ITEMS_FIELD, LOTTERYCMD_CHARID_FIELD, LOTTERYCMD_GUID_FIELD, LOTTERYCMD_TODAY_CNT_FIELD}
...
LOTTERYRECOVERYCMD.fields = {LOTTERYRECOVERYCMD_CMD_FIELD, LOTTERYRECOVERYCMD_PARAM_FIELD, LOTTERYRECOVERYCMD_GUIDS_FIELD, LOTTERYRECOVERYCMD_NPCID_FIELD, LOTTERYRECOVERYCMD_TYPE_FIELD}
...
LOTTERYSUBINFO.fields = {LOTTERYSUBINFO_ITEMID_FIELD, LOTTERYSUBINFO_RECOVER_PRICE_FIELD, LOTTERYSUBINFO_RATE_FIELD, LOTTERYSUBINFO_RARITY_FIELD, LOTTERYSUBINFO_CUR_BATCH_FIELD, LOTTERYSUBINFO_ID_FIELD, LOTTERYSUBINFO_RECOVER_ITEMID_FIELD, LOTTERYSUBINFO_COUNT_FIELD, LOTTERYSUBINFO_FEMALE_ITEMID_FIELD}
...
LOTTERYINFO.fields = {LOTTERYINFO_YEAR_FIELD, LOTTERYINFO_MONTH_FIELD, LOTTERYINFO_PRICE_FIELD, LOTTERYINFO_DISCOUNT_FIELD, LOTTERYINFO_SUBINFO_FIELD, LOTTERYINFO_LOTTERYBOX_FIELD}
...
QUERYLOTTERYINFO.fields = {QUERYLOTTERYINFO_CMD_FIELD, QUERYLOTTERYINFO_PARAM_FIELD, QUERYLOTTERYINFO_INFOS_FIELD, QUERYLOTTERYINFO_TYPE_FIELD, QUERYLOTTERYINFO_TODAY_CNT_FIELD, QUERYLOTTERYINFO_MAX_CNT_FIELD}
...
QUOTALOG.enum_types = {}
QUOTALOG.fields = {QUOTALOG_VALUE_FIELD, QUOTALOG_TYPE_FIELD, QUOTALOG_TIME_FIELD}
...
QUOTADETAIL.fields = {QUOTADETAIL_VALUE_FIELD, QUOTADETAIL_LEFT_FIELD, QUOTADETAIL_EXPIRE_TIME_FIELD, QUOTADETAIL_TIME_FIELD}
...
REQQUOTALOGCMD.fields = {REQQUOTALOGCMD_CMD_FIELD, REQQUOTALOGCMD_PARAM_FIELD, REQQUOTALOGCMD_PAGE_INDEX_FIELD, REQQUOTALOGCMD_LOG_FIELD}
...
REQQUOTADETAILCMD.fields = {REQQUOTADETAILCMD_CMD_FIELD, REQQUOTADETAILCMD_PARAM_FIELD, REQQUOTADETAILCMD_PAGE_INDEX_FIELD, REQQUOTADETAILCMD_DETAIL_FIELD}
...
EQUIPPOSDATA.fields = {EQUIPPOSDATA_POS_FIELD, EQUIPPOSDATA_OFFSTARTTIME_FIELD, EQUIPPOSDATA_OFFENDTIME_FIELD, EQUIPPOSDATA_PROTECTTIME_FIELD, EQUIPPOSDATA_PROTECTALWAYS_FIELD, EQUIPPOSDATA_RECORDGUID_FIELD}
...
EQUIPPOSDATAUPDATE.fields = {EQUIPPOSDATAUPDATE_CMD_FIELD, EQUIPPOSDATAUPDATE_PARAM_FIELD, EQUIPPOSDATAUPDATE_DATAS_FIELD}
...
MATITEMINFO.fields = {MATITEMINFO_ITEMID_FIELD, MATITEMINFO_NUM_FIELD}
...
HIGHREFINEMATCOMPOSECMD.fields = {HIGHREFINEMATCOMPOSECMD_CMD_FIELD, HIGHREFINEMATCOMPOSECMD_PARAM_FIELD, HIGHREFINEMATCOMPOSECMD_DATAID_FIELD, HIGHREFINEMATCOMPOSECMD_NPCID_FIELD, HIGHREFINEMATCOMPOSECMD_MAINMATERIAL_FIELD, HIGHREFINEMATCOMPOSECMD_VICEMATERIAL_FIELD}
...
HIGHREFINECMD.fields = {HIGHREFINECMD_CMD_FIELD, HIGHREFINECMD_PARAM_FIELD, HIGHREFINECMD_DATAID_FIELD}
...
HIGHREFINEDATA.fields = {HIGHREFINEDATA_POS_FIELD, HIGHREFINEDATA_LEVEL_FIELD}
...
NTFHIGHREFINEDATACMD.fields = {NTFHIGHREFINEDATACMD_CMD_FIELD, NTFHIGHREFINEDATACMD_PARAM_FIELD, NTFHIGHREFINEDATACMD_DATAS_FIELD}
...
UPDATEHIGHREFINEDATACMD.fields = {UPDATEHIGHREFINEDATACMD_CMD_FIELD, UPDATEHIGHREFINEDATACMD_PARAM_FIELD, UPDATEHIGHREFINEDATACMD_DATA_FIELD}
...
USECODITEMCMD.fields = {USECODITEMCMD_CMD_FIELD, USECODITEMCMD_PARAM_FIELD, USECODITEMCMD_GUID_FIELD, USECODITEMCMD_CODE_FIELD}
...
ADDJOBLEVELITEMCMD.fields = {ADDJOBLEVELITEMCMD_CMD_FIELD, ADDJOBLEVELITEMCMD_PARAM_FIELD, ADDJOBLEVELITEMCMD_ITEM_FIELD, ADDJOBLEVELITEMCMD_NUM_FIELD}
...
LOTTERGIVBUYCOUNTCMD.fields = {LOTTERGIVBUYCOUNTCMD_CMD_FIELD, LOTTERGIVBUYCOUNTCMD_PARAM_FIELD, LOTTERGIVBUYCOUNTCMD_GOT_COUNT_FIELD, LOTTERGIVBUYCOUNTCMD_MAX_COUNT_FIELD}
...
GIVEWEDDINGDRESSCMD.fields = {GIVEWEDDINGDRESSCMD_CMD_FIELD, GIVEWEDDINGDRESSCMD_PARAM_FIELD, GIVEWEDDINGDRESSCMD_GUID_FIELD, GIVEWEDDINGDRESSCMD_CONTENT_FIELD, GIVEWEDDINGDRESSCMD_RECEIVERID_FIELD}
...
QUICKSTOREITEMCMD.fields = {QUICKSTOREITEMCMD_CMD_FIELD, QUICKSTOREITEMCMD_PARAM_FIELD, QUICKSTOREITEMCMD_ITEMS_FIELD}
...
QUICKSELLITEMCMD.fields = {QUICKSELLITEMCMD_CMD_FIELD, QUICKSELLITEMCMD_PARAM_FIELD, QUICKSELLITEMCMD_ITEMS_FIELD}
...
ENCHANTTRANSITEMCMD.fields = {ENCHANTTRANSITEMCMD_CMD_FIELD, ENCHANTTRANSITEMCMD_PARAM_FIELD, ENCHANTTRANSITEMCMD_FROM_GUID_FIELD, ENCHANTTRANSITEMCMD_TO_GUID_FIELD, ENCHANTTRANSITEMCMD_SUCCESS_FIELD}
...
QUERYLOTTERYHEADITEMCMD.fields = {QUERYLOTTERYHEADITEMCMD_CMD_FIELD, QUERYLOTTERYHEADITEMCMD_PARAM_FIELD, QUERYLOTTERYHEADITEMCMD_IDS_FIELD}
...
LOTTERYRATEINFO.fields = {LOTTERYRATEINFO_TYPE_FIELD, LOTTERYRATEINFO_RATE_FIELD}
...
LOTTERYRATEQUERYCMD.fields = {LOTTERYRATEQUERYCMD_CMD_FIELD, LOTTERYRATEQUERYCMD_PARAM_FIELD, LOTTERYRATEQUERYCMD_TYPE_FIELD, LOTTERYRATEQUERYCMD_INFOS_FIELD}
